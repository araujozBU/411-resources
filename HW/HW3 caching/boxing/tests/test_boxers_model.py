...
#def test_clear_ring(): assert True
...
def test_clear_ring_empty(): assert True
...
def test_get_boxers_empty(): assert True
...
def test_get_boxers_with_data(): assert True
...
def test_get_fighting_skill(): assert True
...
def test_clear_cache(): assert True
